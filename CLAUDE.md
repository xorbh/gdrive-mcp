...
Tell them to add the gdrive entry inside their existing `"mcpServers"` block, separated by a comma. Show them exactly what the merged config should look like so they don't make a JSON syntax error.
